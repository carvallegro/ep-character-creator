  ...
  <StyledNav className="bx--side-nav">
    <div className="bx--side-nav__content">
      <header className="bx--side-nav__title-bar">
        <div className="bx--side-nav__icon">IconINCON</div>
        <div className="bx--side-nav__title-details">
          <div className="bx--side-nav__title">[L1 name here]</div>
        </div>
      </header>
      ...
      <footer className="bx--side-nav__footer">
        <button className="bx--side-nav__toggle">
          <div className="bx--side-nav__icon">ICON ICON</div>
